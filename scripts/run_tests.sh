...
#python3 ../build_all_N.py  --decoder dec2        --platform testing --cores 1  --time 0
...
#python3 ../build_all_GF.py --decoder dec2        --platform testing --cores 1  --time 0
...
#python3 ../build_all_R.py  --decoder dec2        --platform testing --cores 1  --time 0
