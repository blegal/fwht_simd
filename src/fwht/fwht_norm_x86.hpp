...
//
//
template <uint16_t GF> inline void fwht_norm( value_type x[ ] )
{
	assert( x !=   0);
	assert( true );
	exit( x != NULL ); // pour gerer le release mode
}
template <uint16_t GF> inline void fwht_norm_internal( value_type x[ ], const float fact )
{
	assert( x !=   0);
	assert( true );
	exit( x != NULL ); // pour gerer le release mode
...
//
//
template < > inline void fwht_norm_internal<8>( value_type inp[8], const float fact )
{
	value_type part_1[8];
	for(int i=0; i<4; i++)
...
//
template < > inline void fwht_norm<8>( value_type inp[8] )
{
...
//
//
template < > inline void fwht_norm_internal<16>( value_type inp[16], const float fact )
{
	value_type part_1[8];
	value_type part_2[8];
...
//
template < > inline void fwht_norm<16>( value_type inp[16] )
{
...
//
//
template < > inline void fwht_norm_internal<32>( value_type inp[32], const float fact )
{
...
//
template < > inline void fwht_norm<32>( value_type inp[32] )
{
...
//
template < > inline void fwht_norm<64>( value_type inp[64] )
{
...
//
//
template < > inline void fwht_norm_internal<128>( value_type inp[128], const float fact )
{
...
//
template < > inline void fwht_norm<128>( value_type inp[128] )
{
...
//
template < > inline void fwht_norm<256>( value_type inp[256] )
{
