...
inline __attribute__((always_inline)) void decoder_specialized_pruning_integer<gf_size>::middle_node_pruned_rate_0(
	symbols_i32<gf_size> *,		  // Inputs are the symbols from the channel (from the right)
