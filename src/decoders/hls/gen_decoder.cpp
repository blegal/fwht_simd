...
//#pragma HLS dependence class=array direction=RAW variable=internal_r type=inter distance=1 false
  ...
  ////////////////////////////////////////////////////////////////////////////
  //
  // g_function_proba_in_after_rate_0 [hls_generator:769]
  //
...
#pragma HLS PIPELINE
  ...
  ////////////////////////////////////////////////////////////////////////////
  //
  // xor procesing (level 5, pred_is_f =0) [hls_generator:1121]
  //
  cnt_rw = 112;
  cnt_rd = 120;
...
#pragma HLS PIPELINE
  ...
  ////////////////////////////////////////////////////////////////////////////
  //
  // xor procesing (level 6, pred_is_f =1) [hls_generator:1121]
  //
  cnt_rw = 128;
  cnt_rd = 132;
