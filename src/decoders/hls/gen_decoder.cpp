...
#pragma HLS ARRAY_PARTITION dim=1 type=complete variable=memo_in_a.value
  ...
  ////////////////////////////////////////////////////////////////////////////
  //
  // g_function_proba_in_after_rate_0 [hls_generator:742]
  //
  cnt_c = 0; cnt_a = 0; cnt_b = 128;
  loop_g0_2 : for (s = 0; s < 128; s += 1) {
#pragma HLS PIPELINE
    symbols_l[cnt_rw] = 0;
    symbols_r[cnt_rw] = 0;
    cnt_rw += 1;
...
//#pragma HLS dependence variable=internal_r type=inter false
  ...
  loop_rep_9 : for (s = 0; s < 64; s += 1) {
    symbols_l[cnt_rw] = symbol_v;
    symbols_r[cnt_rw] = symbol_v;
    cnt_rw += 1;
    decoded  [cnt_u] = (s == 63) ?  symbol_v : (ap_uint<log2_gf_size>)0;
    cnt_u  += 1;
  }
