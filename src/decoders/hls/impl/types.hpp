...
struct t_uint6b {
  ap_uint<log2_gf_size> value[gf_size];
};
struct t_i_memo {
  ap_int<data_width> value[gf_size];
};
struct t_i_lwht {
  ap_int<i_lwht_width> value[gf_size];
};
struct t_o_lwht {
  ap_int<o_lwht_width> value[gf_size];
};
struct t_i_mult {
  ap_int<i_mult_width> value[gf_size];
};
struct t_o_mult {
  ap_int<o_mult_width> value[gf_size];
};
struct t_i_norm {
  ap_int<i_norm_width> value[gf_size];
};
struct t_o_norm {
  ap_int<o_norm_width> value[gf_size];
};

template <int W, int N> struct t_ram { ap_int<W> value[N]; };
...
//
//
template <int W, int log2N> struct gtuple {
  ap_int<W> value;
  ap_uint<log2N> index;
};
//
...
//
template <int N>
inline void local_remove_xors(uint8_t *dst, uint8_t *src,
...
//
template <>
inline void local_remove_xors<2>(uint8_t *dst, uint8_t *src,
                                 const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
  int cnt_rd = offset + 1;
...
//
template <>
inline void local_remove_xors<4>(uint8_t *dst, uint8_t *src,
                                 const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
  int cnt_rd = offset + 2;
...
//
template <>
inline void local_remove_xors<8>(uint8_t *dst, uint8_t *src,
                                 const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
  int cnt_rd = offset + 4;
...
//
template <>
inline void local_remove_xors<16>(uint8_t *dst, uint8_t *src,
                                  const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
  int cnt_rd = offset + 8;
...
//
template <>
inline void local_remove_xors<32>(uint8_t *dst, uint8_t *src,
                                  const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
...
//
template <>
inline void local_remove_xors<64>(uint8_t *dst, uint8_t *src,
                                  const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
...
//
template <>
inline void local_remove_xors<128>(uint8_t *dst, uint8_t *src,
                                   const uint16_t offset) {
#pragma HLS INLINE
  int cnt_rw = offset;
