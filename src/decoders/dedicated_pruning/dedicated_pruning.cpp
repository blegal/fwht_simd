...
dedicated_pruning<gf_size>::dedicated_pruning(const int n, const int* frozen_symb)
 ...
 */
template <int gf_size>
dedicated_pruning<gf_size>::dedicated_pruning() :
...
template <int gf_size>
void dedicated_pruning<gf_size>::execute(const symbols_t * channel, uint16_t * decoded)
{
    f_tree_cnt = 0;
...
//
#if _GF_ == 16
    template class dedicated_pruning< 16>;
#elif _GF_ == 32
    template class dedicated_pruning< 32>;
#elif _GF_ == 64
    template class dedicated_pruning< 64>;
#elif _GF_ == 128
    template class dedicated_pruning<128>;
#elif _GF_ == 256
    template class dedicated_pruning<256>;
#elif _GF_ == 1024
    template class dedicated_pruning<512>;
#elif _GF_ == 512
    template class dedicated_pruning<1024>;
#endif