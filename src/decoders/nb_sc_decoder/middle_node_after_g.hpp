...
#include "function/f_function_proba_in.hpp"
#include "function/g_function_proba_in.hpp"
#include "function/leaf_node_after_f.hpp"
#include "function/leaf_node_after_g.hpp"

template <int gf_size>
void nb_sc_decoder<gf_size>::middle_node_after_g(
    ...
    const int   symbol_id)  // Symbol ID is the index of the FIRST symbol in the symbols array
{
    ...
    for (int i = 0; i < n; i++) {
        g_function_proba_in<gf_size>(internal + i, inputs + i, inputs + n + i, symbols[symbol_id + i]);
    }
