...
#include "pruning-template/f_function/f_function_freq_in.hpp"
#include "pruning-template/g_function/g_function_freq_in.hpp"
#include "pruning-template/leaf/leaf_node_after_f.hpp"
#include "pruning-template/leaf/leaf_node_after_g.hpp"
...
void DecoderConstexprPruned<gf_size>::middle_node_pruned_after_f(
    ...
    const int   symbol_id)  // Symbol ID is the index of the FIRST symbol in the symbols array
{
    ...
    if (right_edge == RATE_0) {
        ...
        leaf_node_rate_0<gf_size>(internal, decoded, symbols, symbol_id + n, frozen[symbol_id + n]);
        ...
        middle_node_pruned_rep_after_g<gf_size>(internal, internal + n, decoded, symbols, n, symbol_id + n);
