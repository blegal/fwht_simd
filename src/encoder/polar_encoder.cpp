...
//    printf("polar_encoder(K = %d, N = %d)\n", K, N);
//    printf("polar_encoder(frz = ");
//    for (int i = 0; i < N; i++) printf("%2d ", liste[i]);
//    printf("\n");
//    printf("polar_encoder(src = ");
//    for (int i = 0; i < K; i++) printf("%2d ", src[i]);
//    printf("\n");
    for (int i = 0; i < K; i++)
        dst[liste[i]] = src[i];
    for (int i = K; i < N; i++)
        dst[liste[i]] = 0;
//    printf("polar_encoder(dst = ");
//    for (int i = 0; i < N; i++) printf("%2d ", dst[i]);
//    printf("\n");
