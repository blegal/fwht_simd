...
inline void i32_fwht(int32_t x[])
{
	assert(x != 0);
	assert(true);
...
template <uint16_t galois_size>
inline void i32_fwht(int32_t *dst, const int32_t *src)
{
	assert(src != nullptr);
	assert(dst != nullptr);
	assert(true);
...
//
template <>
inline void i32_fwht<8>(int32_t *inp)
{
	int32_t part_1[8];
	for (int i = 0; i < 4; i++)
	{
...
//
template <>
inline void i32_fwht<8>(int32_t *dst, const int32_t *src)
{
...
//
template <>
inline void i32_fwht<16>(int32_t *inp)
{
	int32_t part_1[8];
	int32_t part_2[8];
...
//
template <>
inline void i32_fwht<16>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 8; i++)
	{
		dst[i] = src[i] + src[i + 8];
...
//
template <>
inline void i32_fwht<32>(int32_t *inp)
{
	int32_t part_1[16];
	int32_t part_2[16];
...
//
template <>
inline void i32_fwht<32>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 16; i++)
	{
...
//
template <>
inline void i32_fwht<64>(int32_t *inp)
{
	int32_t part_1[32];
	int32_t part_2[32];
...
//
template <>
inline void i32_fwht<64>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 32; i++)
	{
...
//
template <>
inline void i32_fwht<128>(int32_t *inp)
{
...
//
template <>
inline void i32_fwht<128>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 64; i++)
	{
...
//
template <>
inline void i32_fwht<256>(int32_t *inp)
{
	int32_t part_1[128];
	int32_t part_2[128];
...
//
template <>
inline void i32_fwht<256>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 128; i++)
	{
	...
	i32_fwht<128>(dst, dst);
	i32_fwht<128>(dst + 128, dst + 128);
}
//
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//
template <>
inline void i32_fwht<512>(int32_t *inp)
{
	int32_t part_1[256];
	int32_t part_2[256];
...
//
template <>
inline void i32_fwht<512>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 256; i++)
	{
	...
	i32_fwht<256>(dst, dst);
	i32_fwht<256>(dst + 256, dst + 256);
}
//
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//
template <>
inline void i32_fwht<1024>(int32_t *inp)
{
	int32_t part_1[512];
	int32_t part_2[512];
...
//
template <>
inline void i32_fwht<1024>(int32_t *dst, const int32_t *src)
{
	for (int i = 0; i < 256; i++)
	{
		dst[i] = src[i] + src[i + 256];
