...
python3 ../build_all_N.py  --decoder dec2 --platform optiplex_1c --cores 1 --time 60
...
python3 ../build_all_GF.py --decoder dec2 --platform optiplex_1c --cores 1 --time 60
...
python3 ../build_all_R.py  --decoder dec2 --platform optiplex_1c --cores 1 --time 60
